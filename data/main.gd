...
## Reference to the Procedural map button
@onready var procedural_map: Button = $UI/MapSelector2/LoadProceduralMap
#endregion
...
func _on_load_procedural_pressed() -> void:
	unload_level()
	var level_path: String = "res://assets/maps/level/procedural_level.tscn"  # ← KOMPLETTER PFAD
